                        ...
                        {overviewData.source_speed
                          ...
                          .map((s: any) => (
                            <li key={s.source}>
                              ...
                              <strong>
                                {s.avg_latency_min.toFixed(1)} min
                              </strong>
                            </li>
                          ))}
                      </ul>
              ...
              <div className="charts-grid">
                <div className="glass-panel">
                  ...
                  >
                    ...
                    <button
                      onClick={() =>
                        exportToCSV(chartData, "publication_trend.csv")
                      }
                      className="print-hide"
                      style={{
              ...
              <div className="glass-panel">
                ...
                >
                  {trendingKeywords.length > 0 ? (
                    (() => {
                      const maxCount =
                        Math.max(...trendingKeywords.map((k) => k.count)) || 1;
                      const minCount =
                        Math.min(...trendingKeywords.map((k) => k.count)) || 0;
                      const colors = [
                        "#60a5fa",
                        "#34d399",
                        "#a78bfa",
                      ...
                      return trendingKeywords.map((k, i) => {
                        const size =
                          12 +
                          ((k.count - minCount) / (maxCount - minCount || 1)) *
                            32; // 12px to 44px
                        return (
                          <span
                            key={i}
            ...
            <div className="glass-panel" style={{ minHeight: "600px" }}>
              ...
              >
                ...
                {forYouArticles.length === 0 && (
                  ...
                  >
                    No recommendations found yet. Read some articles to build
                    your profile!
                  </div>
                )}
              </div>
                        ...
                        {adminClickbait?.social?.sources
                          ...
                          .map((s: string, i: number) => (
                            <li key={s}>
                              ...
                              <strong>
                                {adminClickbait.social.volumes[i]}
                              </strong>
                            </li>
                          ))}
                      </ul>
